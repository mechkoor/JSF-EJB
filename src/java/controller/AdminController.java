...
public class AdminController implements Serializable {
    ...
    public static class AdminControllerConverter implements Converter {
        ...
        Admin existingUser = getFacade().findUserByUsernameAndPassword(selected.getUsername(), selected.getPassword());

        if (existingUser != null) {

            return "/employe/List.xhtml"; 
        } else {
           
            JsfUtil.addErrorMessage("Identifiants invalides. Veuillez réessayer.");
            return null; // ou "pageErreur" si vous avez une page d'erreur dédiée
        }
    }
